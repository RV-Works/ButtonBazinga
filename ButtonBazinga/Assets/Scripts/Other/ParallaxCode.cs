...
public class MouseParalaxEffect : MonoBehaviour
{
    ...
    {
        float x, y;
        x = 7 *(Input.mousePosition.x - (Screen.width / 2)) * MouseSpeedX / Screen.width;
        y = 7 *(Input.mousePosition.y - (Screen.height / 2)) * MouseSpeedY / Screen.height;
        //Math things for the paralax
...
//https://www.youtube.com/watch?v=1I1TRXmI-Zg&t=96s